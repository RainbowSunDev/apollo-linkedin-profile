import { calculateDuration } from "#src/utils/calc.js";
            ...
            this.employmentHistory.forEach((item, index) => {
                ...
                if( item.current ) {
                    ...
                    if(start_date && end_date) {
                        this.current_job_years_months = calculateDuration(start_date, end_date); 
                    }
                    ...
                    const end_date = item.end_date;
                    if(start_date && end_date) {
                        this.previous_job_years_months = calculateDuration(start_date, end_date); 
                    }
